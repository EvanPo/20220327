Vue.createApp({
    data() {
        return {
            items: [
                { title: '第一張', subtitle: '第一子標題', bg: '/image/final_layout/dog.jpeg' },
                { title: '第二張', subtitle: '第二子標題', bg: '/image/final_layout/banner.jpeg' },
                { title: '第三張', subtitle: '第三子標題', bg: '/image/final_layout/process.jpeg' },
            ],
            currentIndex: 0,
            timer: '',
            loopSecond: 5
